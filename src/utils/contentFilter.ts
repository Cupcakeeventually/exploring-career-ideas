...
export const checkAllInputsForOffensiveContent = (answers: any): boolean => {
  ...
  for (const input of textInputs) {
    ...
    // Check for suspicious patterns (including prompt injection attempts)
  ...
  // Check priorities for suspicious patterns
  if (typeof answers.priorities === 'string' && containsSuspiciousPatterns(answers.priorities)) {
    return true;
  }
