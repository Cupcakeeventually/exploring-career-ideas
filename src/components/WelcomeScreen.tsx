        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          ...
          <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 mb-8">
            <p className="text-orange-800 text-sm font-medium">
              ⚠️ <strong>Note:</strong> Some school networks block the results page because the tool uses AI. We recommend Careers Advisers do a test run on the school's Wi-Fi before using this tool with a school pupil.
            </p>
          </div>
