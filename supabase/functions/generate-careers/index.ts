...
-If you decide that one of your 20 results should be secondary teaching for a subject not listed, output 'Teacher - Secondary School' as that result instead. The only acceptable teaching roles are those lised: Art and Design, Biology, Business Studies, Chemistry, Drama, English, Gaelic, Geography, History, Home Economics, Mathematics, Modern Languages, Modern Studies, Music, Physical Education, Physics, Religious Education, Computing, Design and technology.
